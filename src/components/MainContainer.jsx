  ...
  return (
    <div>
      <Container>
        ...
        ></Banner>
        <div className="min-h-125   grid grid-cols-10 gap-10">
          ...
          <div className=" col-span-full lg:col-span-3 space-y-4 px-1.5">
            <div className="">
              ...
              <div className="mt-4 space-y-2">
                {progressData.map((student) => (
                  <div
                    key={student.id}
                    className="bg-red-400 p-2.5 space-y-2 mt-2.5 rounded-xl"
                  >
                    <p className="font-bold">{student.title}</p>
                    <button
                      onClick={() => handleInProgress(student.id)}
                      className="bg-green-600 w-full rounded-lg py-1 text-white font-semibold cursor-pointer hover:bg-linear-to-br hover:from-green-600 hover:to-gray-300"
                    >
                      Complete
                    </button>
                  </div>
            ...
            <div className="bg-red-300 p-2 rounded-md shadow-2xl">
              ...
              <div className="space-y-2 mt-3 p-2">
                {resolvedData.map((student) => (
                  <div key={student.id} className="">
                    <p className="font-bold bg-amber-200 py-2.5 pl-3.5 rounded-lg">
                      {student.title}
                    </p>
                  </div>
                ))}
